...
const handleSubmit = (e: React.FormEvent) => {
  ...
  form.method = 'POST';
  form.action = 'https://formsubmit.co/alnishaexports@gmail.com';
  ...
  redirectInput.value = 'https://alnishaexports.com/thank-you';
    ...
    <div className="min-h-screen bg-background font-poppins">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                AL NISHA EXPORTS is a family-run export business based in India, dedicated to 
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">alnishaexports@gmail.com</p>
                  </div>
                </div>
      ...
      <footer className="bg-primary text-primary-foreground py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h3 className="text-2xl font-bold mb-4">AL NISHA EXPORTS</h3>
          <p className="mb-4">Building Trust Across Borders</p>
          <p className="text-sm opacity-80">
            © 2024 AL NISHA EXPORTS. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
